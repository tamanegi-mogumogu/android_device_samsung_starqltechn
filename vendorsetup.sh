...
git clone https://github.com/tamanegi-mogumogu/android_device_samsung_sdm845-common_1 -b udc-wip device/samsung/sdm845-common

echo 'Cloning Device Tree [3/7]'
# Device tree for starqltechn
rm -rf device/samsung/starqltechn
git clone https://github.com/tamanegi-mogumogu/android_device_samsung_starqltechn -b udc-wip device/samsung/starqltechn
...
echo 'Cloning Sepolicy Dependency repo [6/7]'
# Sepolicy
